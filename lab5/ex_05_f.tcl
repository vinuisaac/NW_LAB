...
set namfile [open ex_05_f.nam w]		;# "namfile" is a file pointer for "ex_05.nam"
...
set tracefile [open ex_05_f.tr w]  	;# "tracefile" is a file pointer for "ex_05.tr"
...
$ns duplex-link $n2 $n3 2Mb 10ms DropTail	;# Bottleneck link has less bandwidth. [Assumption: DropTail is used] 
...
exec nam ex_05_f.nam &			;# Creates a new process in background to execute "nam ex_05.nam"
exit 0
}
