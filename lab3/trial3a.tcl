...
set n5 [$ns node]
set n6 [$ns node]
set n7 [$ns node]       ;# Additional Task Step 1

# Setting up links to design the given LAN topology  
#$ns make-lan "$n0 $n1 $n2 $n3 $n4 $n5 $n6" 100Mb 1ms LL Queue/DropTail Mac/802_3 Channel 
...
$ns attach-agent $n7 $udp		;# Configure n1 as the UDP Source
...
# Setup link between N7 and N0
$ns duplex-link $n7 $n0 100Mb 10ms DropTail 
...
#$ns at 23.0 "$ftp stop"			;# FTP application stopped
